...
def create_renders(args):
    ...
    if args.use_spherical_harmonics:
    ...
    if args.use_spherical_harmonics:
        gif_path = os.path.join(args.out_path, "q1-3_spherical_harmonics.gif")
...
def get_args():
    ...
    parser.add_argument("--use_spherical_harmonics", default=False, type=bool)
